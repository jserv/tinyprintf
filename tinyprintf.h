 ...
 * It is a tiny library that gives you basic printing capabilities for very
 * small computer systems. The library is really lightweight - about 400
 * lines of code - and designed for situations where you don't have much
 * computer memory or processing power, like in small embedded devices. It
 * supports printing different types of information like characters, numbers,
 * and text strings, with some basic formatting options.
 *
 ...
 * can get rid of some hundred bytes.
 *
 ...
 * If you rely on re-entrancy, take care that your 'putc' function is
 * re-entrant!
 *
 ...
 * you have variables or struct members with these names, things will explode in
 * your face.  Without variadic macros this is the best we can do to wrap these
 ...
 * clearing 'TINYPRINTF_DEFINE_TFP_PRINTF' and/or 'TINYPRINTF_DEFINE_TFP_SPRINTF'
 * to 0. This allows for example to export only tfp_format, which is at the core
